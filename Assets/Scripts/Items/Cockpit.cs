...
[CreateAssetMenu(fileName = "New Cockpit", menuName = "Mech Item/Cockpit")]
public class Cockpit : Item {

    public bool leftHandSlot = true;
    public bool rightHandSlot = true;
    public bool leftShoulderSlot = false;
    public bool rightShoulderSlot = false;
